data {
  ...
  vector[2] initialValue; //the initial values for choosing left and rigth specified in model fitting (outside stan file)
} 
...
generated quantities{
  ...
  alpha_prior = inv_logit(uniform_rng(0,1)); // something doesnt feel rigth w these distributions ... 
  ...
  alpha_prior_preds = binomial_rng(trials, alpha_prior); 
  ...
  //--------- RUNNING LEARNING TO GET VALUES ---------
  for (t in 1:trials) {
